...
### M4: Filtering
- [x] Add `minMag` and `sinceHours` signals
- [x] Wire filter controls to the signals
- [x] Derive `visibleQuakes` with `computed`
- [x] List and map both reflect the filter
- [x] Core version complete
